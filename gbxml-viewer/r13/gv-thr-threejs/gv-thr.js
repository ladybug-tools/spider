	...
	THR.initThree = function() {
		...
		if ( window.butMenuLoad ) {
			...
			THR.butMenuTemplate = butMenuLoad;

			THR.title = 'gv-thr - gbXML Viewer Three.js';;
			document.title = THR.title;
			aDocumentTitle.innerHTML = THR.title;
			THR.butMenuTemplate.innerHTML = THR.title;
