// Copyright 2018 Ladybug Tools authors. MIT License
	...
	function initAnalemma() {
		...
		if ( ANA.butAnalemma.style.fontStyle !== 'italic' ) {
			...
			parameters.latitude = GBP.gbjson.Campus.Location.Latitude;
			parameters.longitude = GBP.gbjson.Campus.Location.Longitude;
			...
			console.log( 'GBP.surfaceMeshes', GBP.surfaceMeshes );
			*/
	...
	function drawAnalemma() {
		...
		parameters.analemmaRadius = GBP.surfaceMeshes.userData.radius;
