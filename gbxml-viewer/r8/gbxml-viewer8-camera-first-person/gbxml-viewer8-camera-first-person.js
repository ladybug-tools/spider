...
`
	...
	var icw = ifrThree.contentWindow;
	var THREE = icw.THREE;
	var scene = icw.scene;
	var camera = icw.camera;
	var controls = icw.controls;
	var surfaceMeshes = icw.surfaceMeshes
	...
	icw.addAvatar = function( size = surfaceMeshes.userData.radius ) {
...
//		avatar.visible = false;
	...
	icw.zoomOverTheShoulder = function() {
		...
		icw.camera.position.set( 0.2, -2, 0.8 );
