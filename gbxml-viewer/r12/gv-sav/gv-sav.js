...
/*
			GBV.surfaceChanges.surfaceColors = {

				InteriorWall: new THREE.Color( 'skyblue' ),
				ExteriorWall: new THREE.Color( 'pink' ),
				Roof: new THREE.Color( 'aqua' ),
				InteriorFloor: 0x80FFFF,
				ExposedFloor: 0x40B4FF,
				Shade: new THREE.Color( 'gold' ),
