<span style=display:none; >[You are now in a GitHub source code view - click this link to view Read Me file as a web page]( http://www.ladybug.tools/spider/index.html#gbxml-viewer/r10/gbxml-viewer10-05-heads-up-display/README.md  "View file as a web page." ) </span>

# gbXML Viewer10 Heads Up Display Read Me


<iframe class=iframeReadMe src=http://rawgit.com/ladybug-tools/spider/master/gbxml-viewer/r10/gbxml-viewer10-05-heads-up-display/test-gbxml-viewer10-heads-up-display.html width=100% height=400px >Iframes are not displayed on github.com</iframe>


## Full screen test: [Test gbXML Viewer10 Heads Up Display]( http://rawgit.com/ladybug-tools/spider/master/gbxml-viewer/r10/gbxml-viewer10-05-heads-up-display/test-gbxml-viewer10-heads-up-display.html )
