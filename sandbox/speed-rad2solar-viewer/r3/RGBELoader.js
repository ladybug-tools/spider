...
THREE.RGBELoader.prototype._parser = function ( buffer ) {
		...
		RGBE_ReadHeader = function ( buffer ) {
			...
			var line, match,
				...
				header = {
					...
					programtype: 'RADIANCE', /* listed at beginning of file to identify it after "#?". defaults to "RGBE" */

					format: '32-bit_rle_rgbe', /* RGBE format, default 32-bit_rle_rgbe */
	...
	console.log( 'rgbe_header_info', rgbe_header_info );
