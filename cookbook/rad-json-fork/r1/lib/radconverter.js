function create_xyz(xyz){
  ...
  export function parse_sphere(data) {
  ...
  export function parse_cone(data) {
  ...
  export function parse_cylinder(data) {
  ...
  export function parse_plastic(data) {
  ...
  export function parse_glass(data) {
  ...
  export function parse_metal(data) {
  ...
  export function parse_trans(data) {
  ...
  export function parse_glow(data) {
  ...
  export function parse_mirror(data) {
  ...
  export function parse_base(data) {
